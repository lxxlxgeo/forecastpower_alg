...
nohup /mnt/public/home/wasp_dpm/yl_dir/env/miniconda3/condabin/conda run -n powerforecast python power_push_cdq.py >> runlog/shandong_push_cdq.log 2>&1 </dev/null 
echo "功率推送"
